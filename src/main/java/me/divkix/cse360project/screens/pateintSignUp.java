...
public class pateintSignUp {
    public GridPane patientSignUpScreen(Stage primaryStage) {
        ...
        patientSignUp.add(patientMiddleNameLabel, 0, 2); // Add to GridPane at column 0, row 2
        patientSignUp.add(patientMiddleNameField, 1, 2); // Add to GridPane at column 1, row 2
        ...
        patientSignUp.add(patientLastNameLabel, 0, 3); // Add to GridPane at column 0, row 3
        patientSignUp.add(patientLastNameField, 1, 3); // Add to GridPane at column 1, row 3
        ...
        patientSignUp.add(emailLabel, 0, 4); // Add to GridPane at column 0, row 4
        patientSignUp.add(emailField, 1, 4); // Add to GridPane at column 1, row 4
        ...
        patientSignUp.add(phoneLabel, 0, 5); // Add to GridPane at column 0, row 5
        patientSignUp.add(phoneField, 1, 5); // Add to GridPane at column 1, row 5
        ...
        patientSignUp.add(healthHistoryLabel, 0, 6); // Add to GridPane at column 0, row 6
        patientSignUp.add(healthHistoryField, 1, 6); // Add to GridPane at column 1, row 6
        ...
        patientSignUp.add(savePatientInfoButton, 0, 9, 2, 1); // Add to GridPane at column 0, row 9, span 2 columns
        ...
        patientSignUp.add(backButton, 0, 10, 2, 1); // Add to GridPane at column 0, row 10, span 2 columns
