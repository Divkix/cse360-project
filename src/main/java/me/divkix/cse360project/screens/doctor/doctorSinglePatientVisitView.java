...
public class doctorSinglePatientVisitView extends Healnet {
    public static void switchScreen(Stage primaryStage, String patientId, String visitId) {
        VBox screen = new doctorSinglePatientVisitView().screen(primaryStage, patientId, visitId);
    ...
    private VBox screen(Stage primaryStage, String patientId, String visitId) {
        ...
        for (Map<String, String> visit : visitDetails) {
            ...
            System.out.println(visit.get("visit_id"));
        }

        System.out.println(visitId);
        System.out.println(singleVisitDetails);
        ...
        visitDetailslayout.setAlignment(javafx.geometry.Pos.CENTER); // Center the components
