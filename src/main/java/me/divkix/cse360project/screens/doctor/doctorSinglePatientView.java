...
public class doctorSinglePatientView extends Healnet {
    ...
    private VBox screen(Stage primaryStage, String patientId) {
        ...
        leftVBox.setAlignment(javafx.geometry.Pos.CENTER); // Center the components
        ...
        rightVBox.setAlignment(javafx.geometry.Pos.TOP_CENTER); // Center the components

        // get current details of the patient
        java.util.Map<String, String> patient = sqlHelpers.getDataUsingUsernameFromTable(userDetailsTable, patientId);
        java.util.Map<String, String> patientRecord = sqlHelpers.getDataUsingUsernameFromTable(patientDetailsTable, patientId);
        ...
        java.util.Map<String, TextField> textFieldMap = new java.util.HashMap<>();
        ...
        for (java.util.Map.Entry<String, String> entry : patientRecord.entrySet()) {
        ...
        updateButton.setOnAction(e -> {
            java.util.Map<String, String> newPatientRecord = new java.util.HashMap<>();
            for (java.util.Map.Entry<String, String> entry : patientRecord.entrySet()) {
                if (!entry.getKey().equals("username") && !entry.getKey().equals("password") && !entry.getKey().equals("role")) {
        ...
        java.util.List<java.util.Map<String, String>> userVisits = sqlHelpers.getMultipleDataFromTable(patientVisitsTable, "username", patientId);

        // create a vbox to hold the list of visits
        VBox visitList = new VBox(5); // Create a layout with vertical spacing of 5
        visitList.setAlignment(javafx.geometry.Pos.CENTER); // Center the components
        ...
        if (!userVisits.isEmpty()) {
            ...
            for (java.util.Map<String, String> visit : userVisits) {
                ...
                visitLabel.setOnMouseClicked(e -> {
                    ...
                    doctorSinglePatientVisitView.switchScreen(primaryStage, patientId, visit.get("visit_id"));
                });
        ...
        backButton.setOnAction(e -> doctorMainView.switchScreen(primaryStage));
